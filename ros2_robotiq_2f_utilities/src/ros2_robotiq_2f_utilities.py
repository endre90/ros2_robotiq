...
from ros2_robotiq_2f_msgs.msg import Robotiq2FUtilsToGui
from ros2_robotiq_2f_msgs.msg import Robotiq2FGuiToUtils
from ros2_robotiq_2f_msgs.msg import Robotiq2FSPToUtils
from ros2_robotiq_2f_msgs.msg import Robotiq2FUtilsToSP
from ament_index_python.packages import get_package_share_directory

class Ros2Robotiq2FUtilities(Node):

    def __init__(self):
        super().__init__("ros2_robotiq_2f_utilities")
        ...
        self.utils_to_gui_msg = Robotiq2FUtilsToGui()
        ...
        self.joints_oldposes = os.path.join(get_package_share_directory('ros2_robotiq_2f_utilities'),
            'poses', 'joint_oldposes.csv')
        self.joints_newposes = os.path.join(get_package_share_directory('ros2_robotiq_2f_utilities'),
...
def main(args=None):
    ...
    ros2_robotiq_2f_utilities = Ros2Robotiq2FUtilities()

    rclpy.spin(ros2_robotiq_2f_utilities)

    ros2_robotiq_2f_utilities.destroy_node()
    rclpy.shutdown()
