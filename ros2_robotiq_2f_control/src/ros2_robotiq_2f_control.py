...
class Ros2Robotiq2FControl(Node):

   def __init__(self):
      super().__init__("ros2_robotiq_2f_control")
...
def main(args=None):
    ...
    ros2_robotiq_2f_control = Ros2Robotiq2FControl()
    rclpy.spin(ros2_robotiq_2f_control)
    ros2_robotiq_2f_control.destroy_node()
    rclpy.shutdown()
